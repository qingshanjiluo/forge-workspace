...
<head>
    ...
    <style>
        ...
        .alert--danger { background: rgba(231,76,111,0.15); border: 1px solid #e74c6f; color: #e74c6f; }
        .alert--success { background: rgba(78,205,196,0.15); border: 1px solid #4ecdc4; color: #4ecdc4; }
    </style>
</head>
<body>
    <div class="auth-box">
        <h1><i class="fas fa-lock"></i> 登录</h1>
        <div class="sub">工作交流平台</div>
        <?php if (isset($_GET['registered'])): ?>
            <div class="alert alert--success"><i class="fas fa-circle-check"></i> 注册成功，请登录</div>
        <?php endif; ?>
